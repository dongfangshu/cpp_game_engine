...
| [xmake-addons](../../xmake-addons/) | Installing/using addons — `xmake addon`, `add_addons`, `@addon/...` payloads |
| [xmake-addon-development](../../xmake-addon-development/) | Writing/publishing an addon — `addon.lua`, payload layout, `@self` |
